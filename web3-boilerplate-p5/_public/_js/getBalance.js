...
function updateDisplay(){
  ...
  const s0h0 = tag('h1', 'Account Balances')
  const s0h2 = tag('h2', 'Account 1')
  ...
  s0l0.textContent = addresses[0].address;
  s0l1.textContent = 'Celo Balance: '+ addresses[0].balance;

  // Account 2
  const s1h0 = tag('h2', 'Account 2')
  const s1l0 = tag('li', '')
  const s1l1 = tag('li', '')
  const s1h1 = tag('h1', 'TX Hash Lookup')
  const s1l2 = tag('li', '')
  const s1l3 = tag('li', '')
  const s1l4 = tag('li', '')
  ...
  s1l0.textContent = addresses[1].address;
  s1l1.textContent = 'Celo Balance: '+ addresses[1].balance;

  // Transaction data
  s1l2.textContent = "Hash: " + transactions[0].hash;
